    ...
    <div className="min-h-screen bg-[#0A0A0A] flex flex-col items-center justify-center px-4 relative overflow-hidden">
      ...
      <div className="glass-elite glass-elite-large p-12 text-center max-w-md w-full relative z-10">
        ...
        <div
          ...
          style={{
            background: 'linear-gradient(135deg, #FFFFFF, #CFCFCF, #8F8F8F)',
        ...
        <h1 className="text-xl font-semibold text-[#EDEDED] mb-3 font-heading">
          Selector Not Found
        </h1>
        <p className="text-sm text-[#EDEDED]/60 mb-8 leading-relaxed">
          Esta ruta no existe. Incluso nuestra IA no pudo encontrarla.
          <br />
          Confianza: <span className="text-white font-mono">0%</span>
        </p>

        {/* Code-style error */}
        <div className="rounded-xl bg-black/30 border border-white/5 p-4 mb-8 text-left">
          <code className="text-xs font-mono text-[#EDEDED]/50">
            <span className="text-red-400">ElementNotFound:</span>{' '}
            <span className="text-white">cannot locate</span>{' '}
            <span className="text-amber-300">&apos;{typeof window !== 'undefined' ? window.location.pathname : '/this-page'}&apos;</span>
            <br />
            <span className="text-[#EDEDED]/30">{'  '}→ Suggested fix: navigate home</span>
          </code>
        </div>

        <Link
          href="/"
          className="btn-neon inline-flex items-center gap-2 px-6 py-3 rounded-xl text-sm font-semibold text-[#0A0A0A] no-underline"
          style={{
