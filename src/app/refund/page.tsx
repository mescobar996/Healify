  ...
  return (
    <div className="min-h-screen bg-[#0A0A0A] text-[#EDEDED] px-6 py-16 max-w-3xl mx-auto">
      ...
      <div className="space-y-6 text-[#EDEDED]/80 leading-relaxed">
        <section>
          <h2 className="text-xl font-semibold text-white mb-2">1. Período de prueba (Trial)</h2>
          <p>
        ...
        <section>
          <h2 className="text-xl font-semibold text-white mb-2">2. Política de reembolso general</h2>
          <p>
        ...
        <section>
          <h2 className="text-xl font-semibold text-white mb-2">3. Casos en los que no aplica reembolso</h2>
          <p>
        ...
        <section>
          <h2 className="text-xl font-semibold text-white mb-2">4. Cómo solicitar un reembolso</h2>
          <p>
            Enviá un email a{' '}
            <a href="mailto:support@healify.dev" className="text-white">
              support@healify.dev
            </a>{' '}
        ...
        <section>
          <h2 className="text-xl font-semibold text-white mb-2">5. Tiempo de procesamiento</h2>
          <p>
        ...
        <section>
          <h2 className="text-xl font-semibold text-white mb-2">6. Cancelación de suscripción</h2>
          <p>
      ...
      <Link href="/" className="mt-12 inline-block text-sm text-[#EDEDED]/40 hover:text-white">
        ← Volver al inicio
      </Link>
    </div>
  )
