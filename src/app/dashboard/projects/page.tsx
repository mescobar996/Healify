...
function ProjectCard({
  ...
  return (
    <div className={cn(
      ...
      isHighlighted && "ring-1 ring-white/60 border-white/40"
    )}>
      {/* Header */}
      <div className="flex items-start justify-between mb-3">
        <div className="flex items-center gap-2">
          <div className="w-8 h-8 rounded-md bg-gradient-to-br from-white/20 to-white/10 flex items-center justify-center">
      ...
      <div className="grid grid-cols-3 gap-1.5 sm:gap-2 mb-4">
        ...
        <div className="text-center p-2 rounded-md bg-white/5">
          <p className="text-lg font-semibold text-white">{healedTests}</p>
          <p className="text-[10px] text-gray-500 uppercase tracking-wide">
            Curados
          </p>
        </div>
        ...
        <form onSubmit={handleSubmit}>
          ...
          <div className="grid gap-4 py-4">
            <div className="grid gap-2">
              ...
              <Input
                ...
                className="input-glass text-[#EDEDED] placeholder:text-[#EDEDED]/30 focus:border-white/50"
                required
            ...
            <div className="grid gap-2">
              ...
              <Textarea
                ...
                rows={3}
                className="input-glass text-[#EDEDED] placeholder:text-[#EDEDED]/30 focus:border-white/50 resize-none"
                disabled={isSubmitting}
              />
            </div>
            <div className="grid gap-2">
          ...
          <DialogFooter>
            ...
            <Button
              ...
              className="bg-white hover:bg-[#E3E3E3] text-[#0A0A0A]"
            >
              {isSubmitting ? (
                <>
                  <Loader2 className="w-4 h-4 mr-2 animate-spin" />
...
const COMPATIBLE_TOOLS = [
  ...
  { name: "GitHub", svg: <svg viewBox="0 0 24 24" fill="currentColor" className="w-4 h-4 text-[#EDEDED]/70"><path d="M12 0C5.37 0 0 5.37 0 12c0 5.31 3.435 9.795 8.205 11.385.6.105.825-.255.825-.57 0-.285-.015-1.23-.015-2.235-3.015.555-3.795-.735-4.035-1.41-.135-.345-.72-1.41-1.23-1.695-.42-.225-1.02-.78-.015-.795.945-.015 1.62.87 1.845 1.23 1.08 1.815 2.805 1.305 3.495.99.105-.78.42-1.305.765-1.605-2.67-.3-5.46-1.335-5.46-5.925 0-1.305.465-2.385 1.23-3.225-.12-.3-.54-1.53.12-3.18 0 0 1.005-.315 3.3 1.23.96-.27 1.98-.405 3-.405s2.04.135 3 .405c2.295-1.56 3.3-1.23 3.3-1.23.66 1.65.24 2.88.12 3.18.765.84 1.23 1.905 1.23 3.225 0 4.605-2.805 5.625-5.475 5.925.435.375.81 1.095.81 2.22 0 1.605-.015 2.895-.015 3.3 0 .315.225.69.825.57A12.02 12.02 0 0024 12c0-6.63-5.37-12-12-12z"/></svg> },
    ...
    >
      <div className="p-6">
        ...
        <div className="flex items-start gap-3 mb-6">
          <div className="w-10 h-10 rounded-xl bg-gradient-to-br from-white/20 to-white/10 flex items-center justify-center shrink-0 border border-white/20">
          ...
          <div>
            ...
            <p className="text-sm text-[#EDEDED]/50 mt-1">
              ...
              >
                <div className="flex items-start gap-3">
                  ...
                  <div className="min-w-0">
                    ...
                    <p className="text-[11px] text-[#EDEDED]/50 mt-1 leading-relaxed">
                      {step.description}
                    </p>
                  </div>
                </div>
        ...
        <div className="flex flex-col sm:flex-row items-start sm:items-center gap-3 mb-6">
          <Button
            ...
            className="bg-white hover:bg-[#E3E3E3] text-[#0A0A0A] font-semibold text-sm h-10 px-6 w-full sm:w-auto"
          >
          ...
          <Button
            ...
            className="text-[#EDEDED]/50 hover:text-[#EDEDED] text-sm h-10 px-4 w-full sm:w-auto"
          >
            {isSeedingDemo ? (
              <Loader2 className="w-4 h-4 mr-2 animate-spin" />
            ) : (
          ...
          <Button
            variant="ghost"
            asChild
            className="text-[#EDEDED]/40 hover:text-[#EDEDED]/70 text-sm h-10 px-4 w-full sm:w-auto"
          >
            <a href="/docs">
        ...
        <div className="pt-5 border-t border-white/5">
          <p className="text-[10px] font-medium tracking-widest text-[#EDEDED]/25 uppercase mb-2.5">
            Compatible con
          </p>
          <div className="flex flex-wrap gap-2">
            {COMPATIBLE_TOOLS.map((tool) => (
              ...
              >
                {tool.svg}
                <span className="text-[11px] font-medium text-[#EDEDED]/50 group-hover:text-[#EDEDED]/70 transition-colors">
                  {tool.name}
                </span>
              </div>
            ))}
      ...
      <div className="space-y-4">
        ...
        <div className="flex items-center justify-between">
          ...
          <div className="flex items-center gap-2">
            ...
            <Button
              size="sm"
              className="bg-white hover:bg-[#E3E3E3] text-[#0A0A0A] w-full sm:w-auto"
        ...
        <div className="flex flex-col sm:flex-row gap-3">
          <div className="relative flex-1">
            ...
            <Input
              ...
              className="pl-9 input-glass text-[#EDEDED] placeholder:text-[#EDEDED]/30"
            />
          </div>
        ...
        <AlertDialogContent className="bg-[#0D1117] border-white/10 max-w-sm">
          ...
          <div className="space-y-3 py-2">
            <div>
              ...
              <input
                className="w-full bg-white/5 border border-white/10 rounded-lg px-3 py-2 text-sm text-white placeholder:text-gray-600 focus:outline-none focus:border-white/50"
                value={editName}
          ...
          <AlertDialogFooter>
            ...
            <AlertDialogAction
              ...
              className="bg-white hover:bg-[#E3E3E3] text-[#0A0A0A] border-0"
            >
