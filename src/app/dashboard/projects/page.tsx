  ...
  return (
    <div className="group relative p-4 rounded-lg bg-[#0F0F0F] border border-[#1C1C1C] hover:bg-[#111111] hover:border-[#2A2A2A] transition-all duration-150">
      ...
      <div className="flex items-start justify-between mb-3">
        ...
        <DropdownMenu>
          <DropdownMenuTrigger asChild>
            <button className="p-1 rounded-md text-gray-500 hover:text-gray-300 hover:bg-[#111111] transition-colors">
              <MoreVertical className="w-4 h-4" />
            </button>
          </DropdownMenuTrigger>
          <DropdownMenuContent
            align="end"
            className="w-40 bg-[#0F0F0F] border-[#1C1C1C]"
          >
            <DropdownMenuItem 
              className="text-gray-300 text-sm focus:bg-[#111111] focus:text-white cursor-pointer"
              onClick={(e) => {
                e.preventDefault();
            ...
            <DropdownMenuItem className="text-gray-300 text-sm focus:bg-[#111111] focus:text-white">
              <Link
      ...
      <div className="grid grid-cols-3 gap-1.5 sm:gap-2 mb-4">
        <div className="text-center p-2 rounded-md bg-[#111111]">
...
function NewProjectModal({
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="sm:max-w-[500px] w-[calc(100vw-2rem)] sm:w-auto bg-[#0F0F0F] border-[#1C1C1C]">
          ...
          <div className="grid gap-4 py-4">
            <div className="grid gap-2">
              ...
              <Input
                ...
                className="input-glass text-[#E6E6E6] placeholder:text-[#E6E6E6]/30 focus:border-[#10B981]/50"
                required
            ...
            <div className="grid gap-2">
              ...
              <Textarea
                ...
                rows={3}
                className="input-glass text-[#E6E6E6] placeholder:text-[#E6E6E6]/30 focus:border-[#10B981]/50 resize-none"
                disabled={isSubmitting}
              />
            </div>
            <div className="grid gap-2">
  ...
  return (
    <>
        ...
        <div className="flex flex-col sm:flex-row gap-3">
          <div className="relative flex-1">
            ...
            <Input
              ...
              className="pl-9 input-glass text-[#E6E6E6] placeholder:text-[#E6E6E6]/30"
            />
          </div>
      ...
      <AlertDialog open={!!deleteConfirmId} onOpenChange={(open) => !open && setDeleteConfirmId(null)}>
        <AlertDialogContent className="bg-[#0F0F0F] border-[#1C1C1C] max-w-sm">
          <AlertDialogHeader>
          ...
          <AlertDialogFooter>
            <AlertDialogCancel
              className="bg-[#111111] border-[#1C1C1C] text-gray-300 hover:bg-white/10 hover:text-white"
