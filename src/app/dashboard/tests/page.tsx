...
function StatCard({
  ...
  return (
    <div className="group relative p-4 rounded-lg glass-elite hover:border-[#1C1C1C] transition-all duration-150">
      <div className="flex items-start justify-between">
        ...
        <div className={cn("p-2 rounded-md bg-[#111111]", iconColor)}>
  ...
  return (
    <div className="space-y-4">
      ...
      <div className="flex items-center justify-between">
        ...
        <div className="flex items-center gap-2">
          <Button
            ...
            className={cn(
              "bg-[#111111] border-[#1C1C1C] text-gray-300 hover:bg-white/10",
      ...
      <div className="rounded-lg glass-elite">
        ...
        {/* Column Headers */}
        <div className="hidden md:grid grid-cols-12 gap-4 px-4 py-2 text-[11px] font-medium tracking-widest text-gray-500 uppercase border-b border-[#1C1C1C]">
            ...
            <div className="md:hidden divide-y divide-white/5">
              {filteredTestRuns.map((run) => (
                <Link
                  key={run.id}
                  href={`/dashboard/tests/${run.id}`}
                  className="group flex flex-col gap-2 px-4 py-3.5 hover:bg-white/[0.02] active:bg-[#0F0F0F] transition-colors duration-150"
                >
