      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {features.map((feature, i) => (
            <FeatureCard key={i} icon={feature.icon} title={feature.title} description={feature.description} delay={0.1} index={i} />
          ))}
        </div>
      </div>
    </section>
...
function HowItWorksSection() {
  const steps = [
    { step: '1', title: 'Connect', description: 'Link your GitHub repository and CI/CD pipeline in minutes.', icon: FolderGit2 },
    { step: '2', title: 'Detect', description: 'Healify monitors test failures and identifies broken selectors.', icon: Shield },
    { step: '3', title: 'Heal', description: 'AI suggests fixes with confidence scores. Auto-apply or review.', icon: Zap },
  ]
    ...
    <section className="relative py-20 sm:py-28">
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          {/* Once recorded, replace placeholder with:
          <iframe
