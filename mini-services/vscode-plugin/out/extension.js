...
function openDashboardPanel(context) {
    const panel = vscode.window.createWebviewPanel('healifyDashboardPanel', 'Healify Dashboard', vscode.ViewColumn.One, { enableScripts: true });
...
function activate(context) {
    context.subscriptions.push(vscode.commands.registerCommand('healify.openLatestRun', openLatestRun), vscode.commands.registerCommand('healify.openDashboardPanel', () => openDashboardPanel(context)));
}
function deactivate() { }
